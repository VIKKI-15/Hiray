...
<html class="no-js" lang="en">
   <head>
      <title>IQAC Members | Hiray MCA</title>
      <meta charset="utf-8">
         ...
         <div class="container custom-index">
            <div class="row align-items-center justify-content-center">
               <div class="col-12 col-xl-8 col-lg-6">
                  <!-- start page title -->
                  <h1 class="alt-font text-white font-weight-500 no-margin-bottom text-center text-lg-start">IQAC Members</h1>
                  <!-- end page title -->
               </div>
               <div class="col-12 col-xl-4 col-lg-6 breadcrumb justify-content-center justify-content-lg-end text-small alt-font md-margin-10px-top">
                  ...
                  <ul class="xs-text-center">
                     ...
                     <li><a href="#" class="text-white-hover custom-active">IQAC Members</a></li>
                  </ul>
                  <!-- end breadcrumb -->
               </div>
            </div>
                     ...
                     <div id="research" class="tab-pane fade in active show">
                        <div class="row align-items-center">
                           ...
                           <div class="col-12 col-lg-7 col-md-8">
                              <h5 class="w-90 alt-font font-weight-600 text-extra-dark-gray">IQAC</h5>
                              <p class="margin-15px-bottom justified-text">The University Grants Commission (UGC), established in November 1956 as a statutory body of
                                 the Government of India through an Act of Parliament, has the unique distinction of being the
                                 only grant giving agency in the country which has been vested with two responsibilities that of
                                 providing funds and that of coordination, determination and maintenance of standards in
                                 institutions of higher education. To monitor standards of the higher educational institutions the
                                 UGC has established the National Assessment and Accreditation Council (NAAC) as an
                                 autonomous body, under section 12(ccc) of its Act in September 1994.
                              </p>
                              <p class="margin-15px-bottom justified-text">NAAC has been instilling a momentum of quality consciousness amongst Higher Educational Institutions, aiming for continuous improvement. However, lasting improvements in standards cannot come about only by accreditation from outside, once in five years. An internal mechanism for sustenance, assurance and enhancement of the quality culture of education imparted by them, therefore, become essential. Many HEIs already have established the Internal Quality Assurance Cell (IQAC) as a post accreditation quality sustenance activity. Recognizing the importance of such institutional internal quality system the UGC has taken a policy decision to direct all colleges to establish IQAC for which it has decided to provide seed financial assistance</p>
                           </div>
                        </div>
                     </div>
                     <!-- end tab item -->
            ...
            <div class="row">
               <div class="col-12 tab-style-02">
                  ...
                  <div class="tab-content">
                     ...
                     <!-- end tab item -->
                     <!-- start tab item -->
                     <div id="research" class="tab-pane fade in active show margin-three-tb">
                        <div class="row align-items-center">
                           <div class="col-12 col-lg-12 text-center col-md-8">
                              <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-5 justify-content-center">
                                 <!-- start team item -->
                                 ...
                                 <!-- end team item  -->
                                 <!-- start team item  -->
                                 <div class="col team-style-03 text-center md-margin-25px-bottom xs-margin-10px-bottom wow animate__fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                                    <figure class="border-radius-6px box-shadow-medium">
                                       <div class="team-member-image">
                                          <img alt="" src="images/Temp_Image.png" data-no-retina="">
                                       </div>
                        ...
                        <div class="row align-items-center">
                           <div class="col-12 col-lg-12 text-center col-md-8">
                              <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-5 justify-content-center">
                                 ...
                                 <!-- end team item  -->
                                 <!-- start team item  -->
                                 <div class="col team-style-03 text-center wow animate__fadeIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: fadeIn;">
                                    <figure class="border-radius-6px box-shadow-medium">
                                       <div class="team-member-image">
                                          <img alt="" src="images/Temp_Image.png" data-no-retina="">
                                       </div>
                                 ...
                                 <!-- end team item  -->
                                 <!-- start team item  -->
                                 <div class="col team-style-03 text-center wow animate__fadeIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.8s; animation-name: fadeIn;">
                                    <figure class="border-radius-6px box-shadow-medium">
                                       <div class="team-member-image">
                                          <img alt="" src="images/Temp_Image.png" data-no-retina="">
                                       </div>
                                 ...
                                 <!-- end team item  -->
                                 <!-- start team item  -->
                                 <div class="col team-style-03 text-center wow animate__fadeIn" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 1s; animation-name: fadeIn;">
                                    <figure class="border-radius-6px box-shadow-medium">
                                       <div class="team-member-image">
                                          <img alt="" src="images/Temp_Image.png" data-no-retina="">
                                       </div>
